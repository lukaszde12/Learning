...
// Trzy grupy s³ów, które bêd¹ wybierane do zadania!
		String[] listaSlow1 = {"architektura wielowarstwowa", "30000 metrów", "rozwi¹zanie B-do-B", "aplikacja kliencka", "interfejs internetowy", "inteligentna karta", "rozwi¹zanie dynamiczne", "szeœæ sigma", "przenikliwoœæ"};
